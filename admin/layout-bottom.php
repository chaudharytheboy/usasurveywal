...
$(document).on('click', '.swap', function() {
    ...
    $.ajax({
        url: baseURL + "/usasurveywal/admin/update_url.php",
        type: "post",
        data: postDat,
        dataType: "json",
...
$(document).on('click','.removePic',function(){
    ...
    $.ajax({
        ...
        success: function(jsonResponse) {
            if (jsonResponse.status == true) {   
                $(Obj).parent().parent('tr').find('.images').find('img').attr('src',baseURL + '/wal/images/products_image/default-product-img.jpg');                 
