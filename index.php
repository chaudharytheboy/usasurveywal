	...
	<div class="row reviewboxbuttons">
		<div class="col-sm-12">
			...
			<div id="2"  style="display:none">
                ...
                <div class="question center_q">Do you have the official "Walgreens" app installed on your mobile phone?</div>
			...
			<div id="3"  style="display:none">
                ...
                <div class="question center_q">How close to your home is the nearest Walgreens store?</div>
			...
			<div id="4"  style="display:none">
                ...
                <div class="question center_q">How often would you estimate you visit a Walgreens store?</div>
			...
			<div id="5"  style="display:none">
                ...
                <div class="question center_q">Would you consider Walgreens your primary pharmacy?</div>
				<button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Yes</button>
				<button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">No</button>	
			...
			<div id="6"  style="display:none">
                ...
                <div class="question center_q">How would you rate your overall satisfaction with Walgreens?</div>
			...
			<div id="7"  style="display:none">
                ...
                <div class="question center_q">Do you follow Walgreens on any social media websites, such as Facebook, Twitter, Instagram, or Pinterest?</div>
						 ...
						 <div class="row offer-row" style="padding: 12px;margin:5px; border: 1px solid #e3e3e3; border-radius: 3px; background-color:#F5F5F5;">
							...
							<div class="col-md-3 text-center"> <br>
							 ...
							 <?php 
                                            ...
                                            ?>
                                <a id="<?php echo $row['url_1'];?>" class="remove_link" target="_blank"><button id="claim_btn_1" onclick="ViewOffer_1();" style="cursor:pointer;font-size: 1.2em; color: black; margin:auto auto; width:100%; max-height:40px;background:#0d7b19 ;color:#fff ;" class="text-center btn-lg click_claim_btn">Claim Reward →</button></a> 
							 </div>
						 </div> 
                         </div> 
                                <?php 
